...
declare const __PET_CATALOG__: Record<string, { name: string; maxHunger: number; maxScale: number; hoursToMature: number; diet?: string[] }>;
declare const __PLANT_CATALOG__: Record<string, { crop: { baseSellPrice: number; maxScale: number; sprite?: string } }>;
