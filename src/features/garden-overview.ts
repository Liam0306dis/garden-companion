...
function injectStyles(): void {
  ...
  style.textContent = `
    ...
    #${PANEL_ID} header button{width:24px;min-width:24px;height:24px;padding:0;border:0;border-radius:4px;background:rgba(255,255,255,.08);color:#a9d6d6;font-size:12px}
    ...
    #${PANEL_ID} .go-section-title{display:flex;align-items:center;justify-content:space-between;margin-bottom:5px;color:#8dbcbc;font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase}
    ...
    #${PANEL_ID} .go-metric small{display:block;color:#8dbcbc;font-size:8px;text-transform:uppercase;letter-spacing:.08em}#${PANEL_ID} .go-metric b{color:#4caf50;font:700 13px/1.3 ui-monospace,monospace}
    ...
    #${PANEL_ID} .go-progress>div{display:flex;align-items:center;justify-content:space-between;margin-bottom:4px;color:#a9d6d6;font-size:12px}
    ...
    #${PANEL_ID} .go-eta-detail{padding:8px 0;color:#a9d6d6}#${PANEL_ID} .go-eta-detail>div,#${PANEL_ID} .go-eta-done{display:flex;align-items:center;justify-content:space-between}#${PANEL_ID} .go-eta-detail span,#${PANEL_ID} .go-eta-done span{display:flex;align-items:center;gap:7px;font-size:12px}#${PANEL_ID} .go-eta-detail span i,#${PANEL_ID} .go-eta-done span i{width:6px;height:6px;flex:0 0 auto;border-radius:50%}#${PANEL_ID} .go-eta-detail b{font-size:12px}#${PANEL_ID} .go-eta-detail em{color:#555;font-size:10px;font-weight:400;font-style:normal}#${PANEL_ID} .go-eta-detail>u{display:block;height:5px;margin-top:5px;overflow:hidden;border-radius:3px;background:#1a2e2e;text-decoration:none}#${PANEL_ID} .go-eta-detail>u i{display:block;height:100%;border-radius:3px}#${PANEL_ID} .go-eta-detail>small{display:block;margin-top:4px;color:#3a6a6a;text-align:right;font-size:10px}#${PANEL_ID} .go-eta-done{padding:6px 0;color:#a9d6d6}#${PANEL_ID} .go-eta-done span i{background:#34d399}#${PANEL_ID} .go-eta-done b{color:#34d399;font-size:11px}
    #${PANEL_ID} .go-plants{padding-left:10px}#${PANEL_ID} .go-plant-row{display:flex;justify-content:space-between;padding:2px 0;color:#a9d6d6;font-size:12px}
    #${PANEL_ID} .go-plant-row b{font-weight:700}
    #${PANEL_ID} .go-footer{display:flex;align-items:center;justify-content:space-between;padding:8px 16px;background:#0a1f1f;border-top:1px solid #1e3a3a;color:#8dbcbc}
    #${PANEL_ID} .go-footer span{display:flex;align-items:center;gap:8px}#${PANEL_ID} .go-footer span small{padding:1px 6px;border-radius:3px;background:#1e3a3a;color:#8dbcbc;font-size:10px}#${PANEL_ID} .go-footer b{color:#ffd84d;font-size:20px}
