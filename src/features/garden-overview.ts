...
export function initGardenOverview(): void {
  ...
  function normalHtml(stats: OverviewStats): string {
    ...
    const plantRows = plantRowList(stats.species).map(row => {
